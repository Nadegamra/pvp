...
export default function CompanyRegisterPage() {
    ...
    return (
        <>
            {requests.length > 0 && (
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-5 mt-6 p-5">
            ...
            {requests.length === 0 && (
                <div className="m-auto text-center align-middle w-screen pt-20">
